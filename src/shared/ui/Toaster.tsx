...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
    ...
    const typeClasses = {
        ...
        xp: "bg-zinc-900 border-blue-600 shadow-[0_0_20px_rgba(16,185,129,0.15)]",
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none">
            ...
            <div className="relative z-10 flex flex-col items-center animate-in zoom-in-50 fade-in duration-700 ease-out">
                ...
                <div className="text-blue-300 font-bold uppercase tracking-[0.5em] text-sm md:text-base mb-4 drop-shadow-[0_0_10px_rgba(16,185,129,0.8)]">
