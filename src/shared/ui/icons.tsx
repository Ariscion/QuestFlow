...
export function IconHome({ className, ...props }: IconProps) {
    return (
        <svg {...props} className={getIconClassName(className)} viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
export function IconLibrary({ className, ...props }: IconProps) {
    return (
        <svg {...props} className={getIconClassName(className)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconDownloads({ className, ...props }: IconProps) {
    return (
        <svg {...props} className={getIconClassName(className)} viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
export function IconHelp({ className, ...props }: IconProps) {
    return (
        <svg {...props} className={getIconClassName(className)} viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <path d="M9.4 9.4a2.8 2.8 0 1 1 4.2 2.4c-.9.5-1.6 1.1-1.6 2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
